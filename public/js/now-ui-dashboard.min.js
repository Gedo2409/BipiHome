transparent = !0, transparentDemo = !0, fixedTop = !1, backgroundOrange = !1, sidebar_mini_active = !1, toggle_initialized = !1, seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500, debounce = function(a, b, c) {
  var d;
  return function() {
   var e = this,
    f = arguments;
 ...
 function() {
  ...
  }), nowuiDashboard.initMinimizeSidebar(), $navbar = $('.navbar[color-on-scroll]'), scroll_distance = $navbar.attr('color-on-scroll') || 500, 0 != $('.navbar[color-on-scroll]').length && (nowuiDashboard.checkScrollForTransparentNavbar(), $(window).on('scroll', nowuiDashboard.checkScrollForTransparentNavbar)), $('.form-control').on('focus', function() {
