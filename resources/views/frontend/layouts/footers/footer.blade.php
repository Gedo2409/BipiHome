<footer class="footer">
  <div class="row justify-content-between align-items-center bg-gris-2 py-4">
    <div class="col-md-1">
      <svg version="1.1" id="logo_footer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 389 138" style="enable-background:new 0 0 389 138;" xml:space="preserve">
        <g>
          <g>
    ...
    <div class="col text-left">
      <strong class="text-muted">BiPi HOME Xalapa, Veracruz 2018 |</strong>
      <a href="{{ route('front.terminos') }}" class="btn btn-link text-muted">Consulta nuestros términos y condiciones</a>
      <a href="{{ route('front.precios') }}" class="btn btn-link text-muted">¿Quieres pertenecer a la red de BiPi HOME?</a>
      <a href="{{ route('front.contacto') }}" class="btn btn-link text-muted">Contáctanos</a>
    </div>
  </div>
</footer>