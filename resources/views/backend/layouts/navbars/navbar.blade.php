<div class="fixed-top">
  <nav class="navbar navbar-expand-lg bg-azul py-3 justify-content-between fixed-top navbar-light">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="collapsed">
    
      <a href="{{ route('front.index') }}" class="btn btn-link text-white">Volver al Sitio</a>
  		<button type="button" class="btn btn-link text-white" data-toggle="modal" data-target="#modalSesion"><a href="{{ route('logout') }}" class="text-white"
    ...
    {{-- <ul class="nav d-none d-lg-flex">
      ...
      <li class="nav-item">
        <button type="button" class="btn btn-link text-white" data-toggle="modal" data-target="#modalBuscar">
          Acerca de Bipi
        </button>
      </li>

      <li class="nav-item">
        <button type="button" class="btn btn-link text-white" data-toggle="modal" data-target="#modalCarrito">
          Precios
        </button>
      </li>
      <li class="nav-item dorpdown">
        <button type="button" class="btn btn-link text-white" data-toggle="modal" data-target="#modalSesion">
          Iniciar sesión
        </button>
      </li>
    </ul> --}}
